...
class Order(Base):
    ...
    total_price = Column(Float, nullable=False, comment='订单应付金额')
    total_count = Column(Integer, nullable=False, comment='订单商品总数')
    freight = Column(Float, default=0.00, comment='运费')
    pay_price = Column(Float, nullable=False, comment='订单实付金额')
